...
taxid_file = pd.read_csv("/Volumes/metagenomics_drive/apomp/publication/messlier_runs/analysis/messlier_cleaned_taxids.csv", delimiter = ',')
all_taxids = [row[0] for row in taxid_file.values]
...
messlier_guppy_sup_kraken2 = read_input.readPavian(all_taxids,
                                                '/Volumes/metagenomics_drive/apomp/publication/messlier_runs/kraken2/messlier_mock003_out.kraken','kraken2')


#write FPR statistics
fields = ['name','precision','recall','f1']
pipelines = [messlier_guppy_sup_apomp, messlier_guppy_sup_kraken2]
...
filename = "/Volumes/metagenomics_drive/apomp/publication/messlier_runs/analysis/messlier_precision_recall_f1_stats.csv"
...
filename = "/Volumes/metagenomics_drive/apomp/publication/messlier_runs/analysis/reads_per_taxid.csv"
with open(filename, 'w') as csvfile: 
    csvwriter = csv.writer(csvfile) 
    csvwriter.writerow(fields) 
    csvwriter.writerows(rows)
